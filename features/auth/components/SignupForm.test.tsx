...
describe('SignupForm', () => {
    ...
    it('shows error if passwords do not match', async () => {
        ...
        expect(await screen.findByText(/the passwords did not match/i)).toBeInTheDocument();
    ...
    it('handles successful registration with auto-login', async () => {
        ...
        await waitFor(() => {
            expect(toast.success).toHaveBeenCalledWith('Account created! Logging in...');
    ...
    it('handles successful registration requiring email confirmation', async () => {
        ...
        await waitFor(() => {
            ...
            expect(mockPush).toHaveBeenCalledWith(`/sign-in?message=${encodeURIComponent(message)}`);
        });
    });
});
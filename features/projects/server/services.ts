...
export class ProjectService {
    ...
    static async getById(
        ...
        try {
            const project = await this.getProject(supabase, projectId);
    ...
    > {
        ...
        try {
            ...
            const projects = await this.listProjects(supabase, userId, workspaceId);
    ...
    static async create(
        ...
        try {
            ...
            const project = await this.createProject(supabase, {
                name: input.name,
    ...
    static async delete(
        ...
        try {
            ...
            await this.deleteProject(supabase, projectId);

    ...
    if (error || !data) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-y-2">
                <h2 className="text-lg font-semibold text-destructive">Error loading workspace</h2>
                <p className="text-muted-foreground">{error?.message || 'Workspace not found'}</p>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col gap-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Manage workspace projects, settings, and team members.</p>
            </div>
